...
namespace PickslipPrinterV3
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string filename = "Pickslip" + new Random().Next() + ".pdf";
            ...
            //Imple
            Connect(ip, catalog, id, password);
        ...
        public static void Connect(string ip, string catalog, string id, string password)
        {
            //string ip = "172.22.8.143";
            //string catalog = "KRWMS";
            //string id = "jeffrey";
            ...
            dh = new DbHelper(connectionString);
            l = new Logger(Directory.GetCurrentDirectory() + @"\Logger");
            dh.SetLogger(l);
            l.SetDbHelper(dh);
        }
    }
